...
class getSecurity_Authenticator_RememberMe_CustomerService extends Eccube_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['security.authenticator.remember_me.customer'])) {
            return $container->privates['security.authenticator.remember_me.customer'];
        }

        return $container->privates['security.authenticator.remember_me.customer'] = new \Symfony\Component\Security\Http\Authenticator\RememberMeAuthenticator($a, $container->getEnv('ECCUBE_AUTH_MAGIC'), ($container->services['.container.private.security.token_storage'] ?? $container->get_Container_Private_Security_TokenStorageService()), 'eccube_remember_me', ($container->privates['monolog.logger.security'] ?? $container->getMonolog_Logger_SecurityService()));
    }
}
