 ...
 */
class getLimiter_LoginGlobalCustomerService extends Eccube_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['limiter._login_global_customer'] = new \Symfony\Component\RateLimiter\RateLimiterFactory(['policy' => 'fixed_window', 'limit' => 25, 'interval' => '30 minutes', 'id' => '_login_global_customer'], new \Symfony\Component\RateLimiter\Storage\CacheStorage(($container->services['cache.rate_limiter'] ?? $container->getCache_RateLimiterService())), NULL);
    }
}
