 ...
 */
class getConsole_Command_CachePoolPruneService extends Eccube_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['console.command.cache_pool_prune'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\CachePoolPruneCommand(new RewindableGenerator(function () use ($container) {
            ...
            yield 'rate_limiter.cache' => ($container->privates['rate_limiter.cache'] ?? $container->getRateLimiter_CacheService());
