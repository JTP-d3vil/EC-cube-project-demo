...
/* Block/topic.twig */
class __TwigTemplate_2040d81f6cfddc656ec826bf7f91c57de8cb71485bbe270faf07a5f97b95c77a extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
...
<div class=\"ec-topicRole\">
    <div class=\"ec-role\">
        ...
        // line 17
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Special Features"), "html", null, true);
        echo "</span>
        </div>
        ...
        // line 24
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("original ripple design inspired by Japanese bullet trains"), "html", null, true);
        echo "</p>
            </div>
            <div class=\"ec-topicRole__listItem\">
                <a href=\"";
        ...
        echo "\">
                ...
                <p class=\"ec-topicRole__listItemTitle\">";
        // line 30
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Allen Edmonds, an American luxury shoe manufacturer"), "html", null, true);
        echo "</p>
            </div>
        </div>
    </div>
...
<div class=\"ec-topicRole\">
    <div class=\"ec-role\">
        <div class=\"ec-secHeading\">
            ...
            <span class=\"ec-secHeading__line\"></span>
            <span class=\"ec-secHeading__ja\">{{ 'Special Features'|trans }}</span>
        </div>
        <div class=\"ec-topicRole__list\">
            <div class=\"ec-topicRole__listItem\">
                ...
                <p class=\"ec-topicRole__listItemTitle\">{{ 'original ripple design inspired by Japanese bullet trains'|trans }}</p>
            </div>
            <div class=\"ec-topicRole__listItem\">
                <a href=\"{{ url('product_list') }}?category_id=1\">
                    <img src=\"{{ asset('assets/img/top/cover2.jpg') }}\">
                </a>
                <p class=\"ec-topicRole__listItemTitle\">{{ 'Allen Edmonds, an American luxury shoe manufacturer'|trans }}</p>
            </div>
        </div>
    </div>
</div>", "Block/topic.twig", "C:\\xampp\\htdocs\\coolShoes\\ec-cube\\app\\template\\default\\Block\\topic.twig");
    }
}
