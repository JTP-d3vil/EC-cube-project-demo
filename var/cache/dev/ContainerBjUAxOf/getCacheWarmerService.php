 ...
 */
class getCacheWarmerService extends Eccube_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(new RewindableGenerator(function () use ($container) {
            ...
            yield 9 => ($container->privates['exercise_html_purifier.cache_warmer.serializer'] ?? $container->load('getExerciseHtmlPurifier_CacheWarmer_SerializerService'));
        }, 10), true, ($container->targetDir.''.'/Eccube_KernelDevDebugContainerDeprecations.log'));
    }
}
