 ...
 */
class getSecurity_Listener_Customer_UserProviderService extends Eccube_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['security.listener.customer.user_provider'])) {
            return $container->privates['security.listener.customer.user_provider'];
        }

        return $container->privates['security.listener.customer.user_provider'] = new \Symfony\Component\Security\Http\EventListener\UserProviderListener($a);
    }
}
