...
class getAbstractShoppingControllerService extends Eccube_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.l8Il0Lu'] ?? $container->load('get_ServiceLocator_L8Il0LuService'))->withContext('Eccube\\Controller\\AbstractShoppingController', $container));
