...
class Eccube_KernelProdContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $f->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Eccube'.\DIRECTORY_SEPARATOR.'Entity')]), 'Eccube\\Entity');
    ...
    protected function getSecurity_Firewall_MapService()
    {
        ...
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () {
            ...
            yield 'security.firewall.map.context.admin' => ($this->privates['.security.request_matcher.hSE1f73'] ?? ($this->privates['.security.request_matcher.hSE1f73'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/'.$this->getEnv('string:ECCUBE_ADMIN_ROUTE').'/')));
