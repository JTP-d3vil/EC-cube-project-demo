...
/* error.twig */
class __TwigTemplate_7cba54b4f663798562291ce94440de5f374ccc44fc5787e3e6fbdc1aaa4a8227 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
...
<div class=\"ec-layoutRole\">
    <div class=\"ec-404Role\">
        ...
        // line 32
        echo twig_escape_filter($this->env, (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, false, false, 32), "basePath", [], "any", false, false, false, 32) . "/"), "html", null, true);
        echo "\">";
...
";
    ...
    {
        return new Source("", "error.twig", "C:\\xampp\\htdocs\\coolShoes\\ec-cube\\src\\Eccube\\Resource\\template\\default\\error.twig");
    }
}
